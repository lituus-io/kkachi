...
"""
Kkachi Pulumi Table Pipeline (v0.1.0 — Composable Orchestration)
================================================================
...
from kkachi import (
    ...
    Defaults,
    Skill,
    # v0.1.0: Pipeline composition + concurrent execution
    pipeline,
    concurrent,
)
...
def main():
    print("=" * 70)
    print("Kkachi Pulumi Table Pipeline (Python v0.1.0 — Composable Orchestration)")
    print("=" * 70)
    print()
...
{rag_section}"""
    ...
    # v0.1.0: Use pipeline() composition instead of reason()
    preview_result = (
...
A ```yaml code block with category, subcategory, template_name: {folder_name}, keywords, gcp_services, pulumi_resources"""
    ...
    # v0.1.0: Use concurrent() to run deploy and README pipelines in parallel
    concurrent_results = (
        concurrent(llm)
    ...
    print("=" * 70)
    print("Pipeline complete! (v0.1.0 Composable Orchestration)")
    ...
    print()
    print("  New v0.1.0 features used:")
